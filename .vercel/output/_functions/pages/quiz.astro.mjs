...
const $$Quiz = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.request.method === "POST") {
    try {
      ...
      const PUBLIC_FLODESK_API_KEY = "fd_key_c88a04ce001249e29422f92a55996908.MscJtzblMZQPHdVforVVxC9jULCvwo7aDcJjhDwpOJkdOXJwMWWXQBcBPlOk7WG2Vkn4GA3HSQ5Gzw5Kt7b7W4ugK2ExvEZxWgWooKHZZ5IrgRvtpeL0Wz7dm3rG40f1DAL01tYJIcgMYtLRWqbCNe2Vjt3rkRCqm1DYt3CwzKuTfxj2f4mCMSYcsN9oT8Gt";
